...
// shouldRedirToLowercasePath takes a URL path string (such as "/test/guidance")
// and returns:
//   - true, if path is in all caps; for example:
//     "/TEST/GUIDANCE" -> true (should redirect to "/test/guidance")
//   - false, otherwise; for example:
//     "/TeST/gUiDaNcE" -> false (should forward "/TeST/gUiDaNcE" as-is)
